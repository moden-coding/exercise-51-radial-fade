...
from src.radial_fade import center, radial_distance, radial_mask, radial_fade, main
...
class TestRadialFade(unittest.TestCase):
...
class TestMain(unittest.TestCase):
    ...
    def test_main(self):
        with patch("src.radial_fade.plt.subplots", side_effect=plt.subplots) as psubplots,\
             patch("src.radial_fade.plt.subplot", side_effect=plt.subplot) as psubplot, \
             patch("src.radial_fade.radial_mask", side_effect=radial_mask) as pradial_mask,\
             patch("src.radial_fade.radial_fade", side_effect=radial_mask) as pradial_fade,\
             patch("src.radial_fade.plt.show") as pshow:
            main()
